export function getAbout() {
    ...
    Tech Stack: Typescript, Javascript, Node.js, Python, HTML5, CSS
    Frontend technologies: React, Next.js, Angular, Redux, Redux Toolkit, RxJS, NgRx, PWA, SCSS
    Tools: Jest, Testing Library, Gitlab CI/CD, Nginx, WebSocket, Git, Design Systems, Docker, Storybook, AWS, Playwright, Cypress`
}
